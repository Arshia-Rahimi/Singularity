...
sealed interface ClientConnectionState : ConnectionState {
	...
	sealed interface WithDefaultServer : ClientConnectionState {
		val joinedSyncGroup: JoinedSyncGroup
	}

	data class Searching(override val joinedSyncGroup: JoinedSyncGroup) : WithDefaultServer {
		override val message: String
			@Composable get() = Res.string.searching.getString(joinedSyncGroup.syncGroupName)
	}

	data class ConnectionFailed(
		override val joinedSyncGroup: JoinedSyncGroup,
